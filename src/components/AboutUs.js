  ...
  return (
    <div className="about-container">
      ...
      <p>
        ...
        web designing service and e-commerce solutions.Trippy In.Pvt.Ltd.is
        counted for it's expertise in web solutions and its top ranking business
        portals. Our invincible expertise and rich experience has raised our
        spirit to reach ahead from our clients expectation. commendable success
